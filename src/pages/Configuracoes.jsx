  ...
  return (
    <div className="font-sans text-gray-800 max-w-4xl mx-auto space-y-6">
      ...
      <div className="grid grid-cols-1 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-6">
          <div>
            <h2 className="text-lg font-semibold text-gray-900 mb-1">Dados da Empresa (Orçamentos e Contratos)</h2>
            <p className="text-sm text-gray-500">Configure os dados institucionais que serão gerados nos PDFs de propostas e contratos</p>
          </div>
